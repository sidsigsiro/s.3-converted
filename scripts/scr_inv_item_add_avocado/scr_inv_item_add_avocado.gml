...
function scr_inv_item_add_avacodo() {
	...
	*/
	...
	var item_param_0 = "Avocado", //name
			item_param_1 = spr_avocado, //sprite
			item_param_2 = scr_eat_state, //state
			item_param_3 = 18, //stat A (carbs / stam bonus) daily value % x 3 (three meals a day gehehe)
			item_param_4 = 45, //stat B (fats / health bonus)
			item_param_5 = 20, // stat c (proteins / )
