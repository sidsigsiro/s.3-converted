function scr_inv_clothes_create_full() {
	//inv_clothes_slots
	...
	*/
	...
	for (var i = inv_clothes_slots; i > -1; i -= 1) {
		inv_clothes[i,0] = 0;		//item_name

		inv_clothes[i,1] = 0;	//item_icon_sprite

		inv_clothes[i,2] = 0;	//item_type (hat, clothes, backpack, etc...)
	
		inv_clothes[i,3] = 0; //armour_points
	
		inv_clothes[i,4] = 0; //bonus inv_slots
	
		inv_clothes[i,5] = 0; //item_description
	
		inv_clothes[i, 6] = 0; //set sprite index script
