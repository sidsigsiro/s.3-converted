...
function scr_inv_item_add_chickpeas() {
	...
	*/
	...
	var item_param_0 = "Chickpeas", //name
			item_param_1 = spr_chickpeas, //sprite
			item_param_2 = scr_eat_state, //state
			item_param_3 = 21, //stat A (carbs / stam bonus) daily value % x 3 (three meals a day gehehe)
			item_param_4 = 9, //stat B (fats / health bonus)
			item_param_5 = 45, // stat c (proteins / )
			item_param_6 = scr_set_sprite_inventory_heal_stone, //sprite set script
			item_param_7 = 2, //water
			item_param_8 = noone,
			item_param_9 = noone,
