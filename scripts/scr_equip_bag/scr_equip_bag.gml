///scr_equip_shirt
///scr_equip_shirt
function scr_equip_bag() {

	// set temp variables to currently equipped item
	var temp_0 = inv_clothes[3, 0],
		temp_1 = inv_clothes[3, 1],
		temp_2 = inv_clothes[3, 2],
		temp_3 = inv_clothes[3, 3],
		temp_4 = inv_clothes[3, 4],
		temp_5 = inv_clothes[3, 5],
		temp_6 = inv_clothes[3, 6],
		temp_7 = inv_clothes[3, 7],
		temp_8 = inv_clothes[3, 8],
		temp_9 = inv_clothes[3, 9],
		temp_10 = inv_clothes[3, 10];

	//equip clothes to slot
	for(var i =0; i <= global.inv_properties; i++) {
		inv_clothes[3, i] = inv[inv_gui_select, i];
	}
