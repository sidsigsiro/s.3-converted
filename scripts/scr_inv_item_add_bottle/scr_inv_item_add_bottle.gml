...
function scr_inv_item_add_bottle() {
	...
	*/
	...
	var item_param_0 = "Bottle", //name
			item_param_1 = spr_bottle, //sprite
			item_param_2 = scr_drink_state, //state
			item_param_3 = 0, //stat A (carbs / stam bonus) daily value % x 3 (three meals a day gehehe)
			item_param_4 = 0, //stat B (fats / health bonus)
			item_param_5 = 0, // stat c (proteins / )
			item_param_6 = scr_set_sprite_inventory_heal_stone, //sprite set script
			item_param_7 = 0, //water
			item_param_8 = "", //contents
			item_param_9 = noone,
			item_param_10 = noone; //quantity
			item_param_0 = item_param_0 + item_param_8;
	...
	if inv_equip[0,0] = noone {
		...
		inv_equip[0, 10] = item_param_10 return;
		...
		inv_equip[1, 10] = item_param_10 return;
		...
		inv_equip[2, 10] = item_param_10 return;
